<template>
  <div>
    ...
    <div class="table-responsive shadow p-3 mb-5 bg-white rounded" style="display: flex; flex-direction: column; align-items: center; justify-content: center">
      ...
      <canvas ref="chart" style="width: 100%; max-width: 600px"></canvas>
    </div>
  </div>
</template>
